    ...
    <div className="w-full flex flex-col items-center justify-start">
      <div className="h-16 w-full flex items-center justify-between">
        <div className="h-16 w-full flex items-center justify-start gap-8">
          ...
          <button className="h-10 w-fit flex items-center justify-center font-medium bg-gray-200 p-3 rounded-md hover:bg-gray-300">
            Add User
          </button>
          <button className="h-10 w-fit flex items-center justify-center font-medium bg-gray-200 p-3 rounded-md hover:bg-gray-300">
            Delete User
          </button>
          <button className="h-10 w-fit flex items-center justify-center gap-3 font-medium bg-gray-200 p-3 rounded-md hover:bg-gray-300">
            Change Role
      ...
      <div className="h-16 w-full flex items-center justify-center text-[#3b82fe] font-semibold">
      ...
      >
        {currentItems.map((item, index) => (
          <div
            key={item.id}
            className="w-full flex items-center bg-[#d3e1ee] hover:bg-[#c0d6ee] rounded-md cursor-pointer"
          >
