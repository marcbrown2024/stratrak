...
const Page = () => {
  ...
  return (
    <div className="h-fit w-full flex flex-col items-center justify-center bg-slate-50 md:pl-20">
      {/* Info Cards */}
      <div className="h-fit w-full flex flex-col md:flex-row items-center justify-center bg-slate-50 z-10 gap-4 md:gap-8 p-4">
        <div className="h-48 w-full md:w-80 flex flex-col items-start justify-between bg-[#1286ff] p-6 rounded-xl hover:bg-[#1285dd] transition-colors duration-200">
