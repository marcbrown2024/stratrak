  ...
  return (
    <div className="h-full w-full flex items-center justify-center">
      <div className="h-full w-4/6 flex flex-col items-center justify-center gap-12">
        <h1 className="text-2xl md:text-4xl text-gray-700 font-bold tracking-wider">
          Technical Support
        </h1>
        <form
          onSubmit={handleSubmit}
          className="h-full w-full flex flex-col items-center justify-start gap-8 text-gray-600 font-semibold"
        >
          <div className="h-fit w-full flex items-center justify-center gap-10">
            <label htmlFor="firstName" className="w-1/2 flex flex-col gap-2">
              First Name
              <input
                id="firstName"
                name="firstName"
            ...
            <label htmlFor="lastName" className="w-1/2 flex flex-col gap-2">
              Last Name
              <input
                id="lastName"
                name="lastName"
          ...
          <div className="h-fit w-full flex items-center justify-center gap-10">
            <label
              htmlFor="email"
              className="h-fit w-full flex flex-col items-start justify-center gap-2"
            >
              Email
              <input
                id="email"
          ...
          <div className="h-fit w-full flex flex-col items-center justify-center gap-10">
            ...
            >
              ...
              <input
                ...
                className="w-full sm:text-sm lg:text-base sm:leading-6 bg-transparent p-2 border border-transparent rounded-md ring-1 ring-inset ring-gray-300 outline-0 focus:border-gray-800 active:border-gray-800"
              />
            ...
            <label
              htmlFor="message"
              className="h-60 w-full flex flex-col items-start justify-center gap-2"
            >
              Message
              <textarea
                id="message"
                ...
                className="h-full w-full sm:text-sm lg:text-base sm:leading-6 bg-transparent p-2 border border-transparent rounded-md ring-1 ring-inset ring-gray-300 outline-0 focus:border-gray-800 active:border-gray-800"
              />
